...
export const roomLayoutMetadata = {
  ...
  furniturePlacements: [
    ...
    {
      id: 'coffee-table',
      groupPosition: [0, 0.38, -1.185] as Vec3,
      model: { path: '/models/kenney/tableCoffee.glb', position: [0.294, -0.38, 0.1] as Vec3, scale: [2.25, 2.05, 2.15] as Vec3 },
    ...
    {
      id: 'spotify-speaker',
      groupPosition: [-2.72, 0, -2.78] as Vec3,
      collisionRect: 'destination-spotify',
      notes: ['Procedural walnut speaker and steel stand; this is a destination-owned collision rectangle.'],
    },
    {
      ...
      models: [
        ...
        { path: '/models/kenney/plant_flatTall.glb', position: [0.04, 0.82, 0.02] as Vec3, rotationY: -0.35, scale: 1.36 },
        { path: '/models/kenney/plant_bushDetailed.glb', position: [0.02, 0.7, 0.02] as Vec3, rotationY: 0.85, scale: 0.96 },
      ],
...
export const modelAssetMetadata: readonly ModelAssetMetadata[] = [
  ...
  },
  {
    ...
    notes: ['Origin is not centered; model placement adds [0.294, -0.38, 0.1] inside the table group.'],
  },
  {
